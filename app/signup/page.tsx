                ...
                <Card className="w-full border border-neutral-200 shadow-2xl rounded-xl bg-white/80 backdrop-blur-sm">
                    ...
                    <CardContent className="grid gap-5 px-8 pb-8">
                        ...
                        <div className="grid gap-4">
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="confirm-password" className="font-medium text-neutral-700">Confirm Password</Label>
                                <Input id="confirm-password" type="password" className="h-10 border-neutral-200 bg-white" />
                            </div>
                        </div>
                        <Button className="w-full h-10 text-base font-medium shadow-md">Create account</Button>
                    </CardContent>
                    <CardFooter className="pb-8 border-t border-neutral-100 pt-6">
